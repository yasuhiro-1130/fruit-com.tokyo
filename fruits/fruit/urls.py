...
urlpatterns = [
    ...
    path('sign_up/',views.SignUp.as_view(), 
	      name='sign_up'),
    path('sign_up/done/<token>',views.SignUpDone.as_view(), 
	      name='sign_up_done'),
    ...
    path('password_reset/cofirm/<uidb64>/<token>/',views.PasswordResetConfirm.as_view(),
    ...
    path('email/change/complete/<str:token>/',views.EmailChangeComplete.as_view(),
    ...
    # 果物農場ページ/CRUD
    path('farm_info/<int:pk>',views.FarmInfo.as_view(),
          name='farm_info_page'),
    path('farm_info_redirect/<int:pk>',views.FarmInfoRedirect.as_view(),
          name='farm_info_redirect'),
    path('farm_info_register/<int:pk>',views.FarmInfoRegister.as_view(),
          name='farm_info_register'),
    path('farm_info_change/<int:farm_pk>',views.FarmInfoChange.as_view(),
          name='farm_info_change'),
    path('farm_info_delete/<int:farm_pk>',views.FarmInfoDelete.as_view(),
          name='farm_info_delete'),

    # 果物出品ページ/CRUD
    path('farm_products_list/', 
	      views.FarmProductsList.as_view(), 
		  name='farm_products_list'),
    path('farm_product_register/<int:farm_pk>',
	      views.FarmProductRegister.as_view(),
          name='farm_product_register'),
    path('farm_product_change/<int:farm_product_pk>',
          views.FarmProductChange.as_view(),
          name='farm_product_change'),
    path('farm_product_delete/',
          views.FarmProductsDelete,
          name='farm_product_delete'),

    # ショッピングカート
    path('cart_item_list/', views.ShoppingCartItemList, 
	      name='cart_item_list'),
    path('cart_confirm/<int:cart_pk>', views.ShoppingCartConfirm.as_view(), 
	      name='cart_confirm'),
    path('ajax_cart_delete/', views.delete_cart_item, 
	      name='delete_cart_item'),
    path('ajax_cart_plus/', views.plus_cart_item, 
	      name='plus_cart_item'),
    path('ajax_cart_minus/', views.minus_cart_item, 
	      name='minus_cart_item'),
]
