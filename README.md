...
## このサービスを作成した経緯
世の中のwebサービスを俯瞰して見たところ、売り手・買い手、寄付したい人・寄付されたい人、雇いたい人・雇われたい人、捨てたい人・拾いたい人など、何らかのマッチングサービスが多いことに気づきました。そこで、そのようなマッチングサービスを自ら作ってみることで、web開発を仕事にするにあたり必須かつ基本的なポイントが一通り学べると思い、このようなサービスを作ってみることにしました。
